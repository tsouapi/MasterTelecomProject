              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                <thead>
                  <tr style="background-color: #084AFF">
                    ...
                    <th >Network Throughput IP(Mbps) </th>
                    <th >Network Throughput (MAC layer)(Mbps)</th>
                ...
                <tbody>
                  <tr>
                    <td style="background-color: #9999FF">Uplink</td>
                    <td style="background-color: #9999FF"><?php echo "".lted($up,$zone)*1024; ?></td>
                    <td style="background-color: #9999FF"><?php echo "".lted($up,$zone)*$n; ?></td>
                    <td style="background-color: #9999FF"><?php echo "".lted($up,$zone)*$n/0.9804; ?></td>
                   
                    <td> <center><a href=""> <img src="images/modifier.jpg" width="40"> </a></center></td>
                  </tr>
                   <tr>
                    <td style="background-color: #66FFFF">Downlink</td>
                    <td style="background-color: #66FFFF"><?php echo "".lted($dw,$zone)*1024; ?></td>
                    <td style="background-color: #66FFFF"><?php echo "".lted($dw,$zone)*$n; ?></td>
                    <td style="background-color: #66FFFF"><?php echo "".lted($dw,$zone)*$n/0.9804; ?></td>
