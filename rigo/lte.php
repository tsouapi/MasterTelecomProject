...
include'conbd.php';
require 'foction.php';
  $resultat= $DB -> query('SELECT * FROM downlink,uplink where downlink.nom_service=uplink.nom_service order by downlink.id asc ');
...
$i = 0;
         ...
         {?>   
          ...
          <a href="<?php echo "calcul.php"?>"><button type="submit" class="btn btn-primary">continuer</button></a>
        </div>
      </div>
